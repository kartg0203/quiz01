...
Route::prefix('/admin')->middleware('auth')->group(function () {
    ...
    // update 這邊的patch是用表單(form)傳送的 所有用@method(patch)
    ...
    // show 顯示或隱藏 這邊的patch是用axios.patch()送的
...
//             break;
//         case 'ad':
//             return view('backend.module', ['header' => '動態網站文字管理', 'module'=>'Ad']);
//             break;
//         case 'image':
...
//             break;
//         case 'total':
//             return view('backend.module', ['header' => '網站人數管理']);
//             break;
//         case 'bottom':
